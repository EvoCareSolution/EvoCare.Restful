...
namespace EVOpsPro.Repositories.KhiemNVD.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected FA25_PRN232_SE1713_G2_EVOpsProContext _context;

        public GenericRepository()
        {
            _context ??= new FA25_PRN232_SE1713_G2_EVOpsProContext();
        }

        public GenericRepository(FA25_PRN232_SE1713_G2_EVOpsProContext context)
        {
            _context = context;
        }
